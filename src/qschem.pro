...
HEADERS += ui/HoverManager.h   ui/ConnBuilder.h   ui/Editor.h
SOURCES += ui/HoverManager.cpp ui/ConnBuilder.cpp ui/Editor.cpp
HEADERS += svg/Router.h   svg/Geometry.h   svg/CircuitMod.h
SOURCES += svg/Router.cpp svg/Geometry.cpp svg/CircuitMod.cpp
SOURCES += qschem.cpp	
