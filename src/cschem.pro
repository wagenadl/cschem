...
HEADERS += ui/Style.h   circuit/Textual.h
SOURCES += ui/Style.cpp circuit/Textual.cpp
HEADERS += circuit/CircuitModData.h      circuit/ContainerConflicts.h
SOURCES += circuit/CM_MergeSelection.cpp circuit/ContainerConflicts.cpp
