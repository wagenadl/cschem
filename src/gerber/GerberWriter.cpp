...
private:
  ...
  // negative polarity means to draw clearance, with appropriate trace widths
...
bool GWData::writeTracksAndPads(GerberFile &out, Layer layer,
  ...
  qDebug() << "GWData: Outputing pads NYI";
