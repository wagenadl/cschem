...
HEADERS += ../cschem/circuit/Element.h
HEADERS += ../cschem/circuit/Connection.h
HEADERS += ../cschem/circuit/PartNumbering.h
HEADERS += ../cschem/circuit/SafeMap.h
HEADERS += ../cschem/circuit/Net.h
HEADERS += ../cschem/circuit/Textual.h
HEADERS += ../cschem/file/FileIO.h
HEADERS += ../cschem/svg/XmlElement.h
HEADERS += ../cschem/svg/XmlNode.h
HEADERS += ../cschem/svg/Symbol.h
HEADERS += ../cschem/svg/SymbolLibrary.h
