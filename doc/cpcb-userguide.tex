...
\begin{enumerate}
\item Design your layout and have your board manufactured.
\item Export the paste mask as an svg file with 0.005'' (0.125 mm)
  ...
  \item  Cut the paste mask out of overhead transparency. I use Apollo
    ...
    \item Tape the mask to the board. I used packing tape, but it is
...
\item Squeeze solder paste into the pads. The paste I have been using
  is Sn 42\%/Bi 57\%/Ag 1\%, melting point 137 $^\circ$C. It is
  described as ``No-clean flux, 87\% metal (20--38 microns).''
      
      . Standard old-fashioned overhead projector sheets can be cut
      with most laser cutters, and if you experiment with the energy
      and speed settings, you should be able to produce clean
      holes. (On my laser cutter, I find that the cleanest holes are
      made by going over the outlines of pads several times rapidly at
      low power. The final result is a slight ridge on the top side of
      the sheet, and a perfectly flat bottom side.) Many sources now
      sell lead-free solder paste that melts at temperatures as low as
      140 $^\circ$C, which practically obviates the risk of
      overheating components. I use painter's tape to temporarily
      attach the solder mask to the PCB, apply a little solder paste
      over all SMT components, and use a plastic or metal spatula to
      push the paste into the holes in the mask. A stereoscope is
      useful to check the quality of your work, but if you have good
      eye sight, a simple magnifying glass might be good enough. (A
      pair of +2.00 to +2.50 reading glasses makes for a remarkably
      effective head-mounted magnifier.)}

\footnote{The default value,
  0.005 inch (0.125 mm), works well for my laser cutter. I typically
  use 0.002-inch-thick (0.050 mm) transparency sheets. My 75-W ULS
  laser cutter creates clean holes if I cut the outlines of the pads three times
  at 25\% power and 100\% speed.}
